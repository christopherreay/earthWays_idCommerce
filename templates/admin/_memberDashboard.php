<div class="memberdeck">
				...
				<?php 
					if (isset($download_array['visible'])) {
						foreach ($download_array['visible'] as $extension) { 
							...
							?>
				<li class="expiring">
					<div class="idc-dashboard-download-image <?php echo $extension->image_layout ?>" data-image-width="<?php echo $extension->image_width ?>" data-image-height="<?php echo $extension->image_height ?>" style="background-image: url(<?php echo $extension->image_link; ?>);">
                    <img src="<?php echo $extension->image_link; ?>" /></div>
					...
					foreach ($download_array['invisible'] as $hidden) {
						...
						<li class="inactive" data-levelid="<?php echo (isset($hidden->occ_level) && $hidden->occ_level > 0 && $show_occ == true ? $hidden->occ_level : ''); ?>" data-pid="<?php echo (isset($hidden->occ_level) && $hidden->occ_level > 0  && $hidden->id_project > 0 ? $hidden->id_project : ''); ?>">	
                            ...
                            <a class="inactive-item" href="<?php echo $hidden->info_link; ?>">
								<div class="idc-dashboard-download-image <?php echo $hidden->image_layout ?>" data-image-width="<?php echo $hidden->image_width ?>" data-image-height="<?php echo $hidden->image_height ?>" style="background-image: url(<?php echo $hidden->image_link; ?>);"><img src="<?php echo $hidden->image_link; ?>" /></div>
    ...
    <div class="tt-footer"><!--<a class="tt-more" href="#"><?php// _e('Learn More', 'memberdeck'); ?></a>&nbsp; -->
