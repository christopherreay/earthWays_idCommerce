							...
							<div class="columns" style="width: 29%; padding-right: 2.5%; margin-right: 2.5%; border-right: 1px solid #C8D3DC;">
								...
								<div class="form-input">
									...
									<select id="stripe_currency" name="stripe_currency">
                                        ...
                                        <option value="SEK" <?php echo (isset($stripe_currency) && $stripe_currency == 'SEK' ? 'selected="selected"' : ''); ?>><?php _e('SEK', 'memberdeck'); ?></option>
                                        <option value="CHF" <?php echo (isset($stripe_currency) && $stripe_currency == 'CHF' ? 'selected="selected"' : ''); ?>><?php _e('CHF', 'memberdeck'); ?></option>
                                        <option value="DKK" <?php echo (isset($stripe_currency) && $stripe_currency == 'DKK' ? 'selected="selected"' : ''); ?>><?php _e('DKK', 'memberdeck'); ?></option>
									</select>
								</div>
								<div class="form-input">
