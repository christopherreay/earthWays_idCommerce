					...
					<div class="inside">
						<form method="POST" action="" id="gateway-settings" name="gateway-settings">
							...
							<span><?php _e('Leave empty to use default template', 'memberdeck'); ?></span>
								...
								<div class="form-row preorder_receipt email_text" style="display: none"><?php wp_editor((isset($template_array['preorder_receipt']) ? $template_array['preorder_receipt'] : ''), "preorder_receipt_text"); ?></div>
