<div id="finaldescCoinbase" class="finaldesc" style="display:none; word-wrap: none;" data-cb-symbol="<?php echo $cb_symbol; ?>">
	...
	<p class="combined-product-desc"><?php echo ((isset($combined_purchase_gateways['cb']) && $combined_purchase_gateways['cb']) ? __('Recurring product', 'memberdeck').' <b>'.$combined_level->level_name.'</b> '.__('is combined with this Product', 'memberdeck') : '') ?></p>
</div>