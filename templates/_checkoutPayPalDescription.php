<div id="finaldescPayPal" class="finaldesc" style="display:none; word-wrap: none;">
	...
	<p class="combined-product-desc"><?php echo ((isset($combined_purchase_gateways['pp']) && $combined_purchase_gateways['pp']) ? __('Recurring product', 'memberdeck').' <b>'.$combined_level->level_name.'</b> '.__('is combined with this Product', 'memberdeck') : '') ?></p>
</div>